  ...
  return (
    <div className="nt-noprint">
      ...
      {!open && !hideBubble && (
        ...
        >
          <span className="nt-r-md" style={{ background: "var(--bg)", color: "var(--ink)", border: "2px solid var(--bd)", padding: "9px 13px", fontSize: 12.5, fontWeight: 700, boxShadow: "0 6px 18px rgba(0,0,0,.12)", whiteSpace: "nowrap" }}>
            Un devis en une phrase ?
          </span>
          <span className="nt-r-sm" style={{ position: "relative", width: 56, height: 56, background: "var(--accent)", color: "var(--navy)", border: "2px solid var(--navy)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 26, boxShadow: "0 8px 22px rgba(0,0,0,.22)" }}>
            N
